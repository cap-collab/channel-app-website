...
export function VenueClient() {
  ...
  const participantIdentity = currentSlot?.djName || 'Venue DJ';
      ...
      if (timeLeft <= 0) {
        ...
        if (nextSlot && nextSlot.broadcastType === 'venue') {
          ...
          setDjChangeWarning({
            ...
            subMessage: nextSlot
              ? `${nextSlot.djName} is broadcasting remotely`
        ...
        setDjChangeWarning({
          ...
          subMessage: nextSlot ? `${nextSlot.djName} is up next` : undefined,
        });
        ...
        setDjChangeWarning({
          ...
          subMessage: nextSlot
            ? `${nextSlot.djName} takes over in ${minutes} minute${minutes !== 1 ? 's' : ''}`
        ...
        <div className="bg-gray-900 rounded-xl p-8 max-w-md text-center">
          ...
          {nextSlot && (
            <div className="bg-gray-800 rounded-lg p-4 mt-4">
              ...
              <p className="text-white font-medium">{nextSlot.showName || nextSlot.djName}</p>
        ...
        <div className="mb-8">
          ...
          <div className="mt-2">
            <p className="text-gray-400">
              <span className="text-white font-medium">{currentSlot.showName || currentSlot.djName}</span>
              {currentSlot.showName && <span> &bull; {currentSlot.djName}</span>}
            </p>
            <p className="text-gray-500 text-sm">
        ...
        {audioStream && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-800 rounded-lg p-4 text-center">
              ...
              <p className="text-white font-medium">{currentSlot.showName || currentSlot.djName}</p>
