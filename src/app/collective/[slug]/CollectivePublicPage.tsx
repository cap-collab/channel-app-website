  ...
  useEffect(() => {
    async function fetchCollective() {
      ...
      try {
        ...
        const q = query(collectivesRef, where("slug", "==", slug));
        ...
        try {
          ...
          eventsSnapshot.forEach((eventDoc) => {
            ...
            eventsList.push({
              ...
              collectiveId: eventData.collectiveId || null,
        ...
        <main className="max-w-5xl mx-auto px-6 py-16">
          <div className="text-center py-12">
            ...
            <p className="text-zinc-600 text-sm">
              The collective &quot;{slug}&quot; doesn&apos;t exist.
            </p>
          </div>
        </main>
      </div>
  ...
  return (
    <div className="min-h-screen text-white relative">
      ...
      <main className="max-w-5xl mx-auto px-6 py-4 pb-24">
        ...
        {/* SECTION B: DJs */}
        {collective.residentDJs && collective.residentDJs.length > 0 && collective.residentDJs.some(dj => dj.djName) && (
        ...
        {collective.linkedVenues && collective.linkedVenues.length > 0 && (
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {collective.linkedVenues.map((venue: CollectiveVenueRef) => (
                <div
                  key={venue.venueId}
                ...
                >
                  ...
                  <span className="text-sm text-white font-medium truncate">{venue.venueName}</span>
                </div>
              ))}
            </div>
          </section>
              ...
              {collective.linkedCollectives.map((coll: CollectiveRef) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-zinc-800 flex items-center justify-center flex-shrink-0 overflow-hidden">
                    {coll.collectivePhoto ? (
                      <Image
                        src={coll.collectivePhoto}
                        alt={coll.collectiveName}
                        width={40}
                        height={40}
                        className="w-full h-full object-cover"
                      />
