    ...
    <div className="relative">
      ...
      >
        <div className="grid grid-rows-2 grid-flow-col gap-3 auto-cols-[calc(50%-0.375rem)] md:auto-cols-[calc(33.333%-0.5rem)]">
          {items.map((it) => {
            // Fallback when no photo: a solid gray fill for collectives (no SVG icon),
            // and the person silhouette for DJs.
            ...
            const inner = (
              <div className="flex items-start gap-3 bg-zinc-900/50 border border-white/10 rounded-lg p-3 hover:bg-zinc-800/50 transition-colors h-[78px] overflow-hidden">
                ...
                <div className="min-w-0 flex-1 overflow-hidden">
                  ...
                  {it.bio && (
                    <>
                      {/* Mobile: single-line bio, clamped to keep card height uniform */}
                      <p className="md:hidden text-zinc-400 text-xs mt-1 truncate">{it.bio}</p>
                      {/* Desktop: 2-line bio */}
