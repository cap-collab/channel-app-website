  ...
  return (
    <div className="fixed top-[52px] left-0 right-0 z-[99] bg-black border-b border-white/10">
      <div className="flex items-center gap-3 py-2 px-4">
        ...
        {/* Love icon */}
        <Link href="/radio#live" className="w-10 h-10 flex items-center justify-center bg-white/10 text-accent flex-shrink-0">
        ...
        {/* Tip icon */}
        <Link href="/radio#live" className="w-10 h-10 flex items-center justify-center bg-white/10 text-green-400 flex-shrink-0">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
