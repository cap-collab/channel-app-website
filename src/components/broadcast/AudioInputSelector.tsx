...
const inputMethods = [
  {
    ...
    title: 'System Audio',
    description: 'Capture audio from Serato, Rekordbox, Traktor, or any app playing on your computer',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
    ),
    note: 'Requires screen share permission',
  },
  {
    id: 'device' as AudioInputMethod,
    title: 'Audio Interface',
    description: 'Use an external audio interface or USB mixer connected to your computer',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
      </svg>
    ),
    note: 'CDJs, mixer, or audio interface',
  },
  {
    id: 'rtmp' as AudioInputMethod,
    title: 'OBS / Encoder',
    description: 'Stream via RTMP using OBS Studio or a hardware encoder',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
      </svg>
    ),
    note: 'For pro setups with OBS',
  },
];
        ...
        {inputMethods.map((method) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              {method.note && (
                <p className="text-gray-500 text-xs mt-2">{method.note}</p>
              )}
            </div>
